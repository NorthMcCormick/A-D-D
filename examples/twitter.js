...
var ADDConfig = require('./../lib/index.js').Config;
var ADDDenormalizer = require('./../lib/index.js').Denormalizer;

var ADDDatabase_Firebase = require('./../databaseHandlers/add.firebase.db.js');
var ADDDatabase_IonicDB = require('./../databaseHanlders/add.ionicdb.db.js');
